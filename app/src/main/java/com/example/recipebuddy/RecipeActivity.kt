...
import com.example.recipebuddy.databinding.ActivityRecipeBinding
...
class RecipeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for( i in 1 until ing!!.size){
            val ingredient = ing[i]
            // Adjust the length of the ingredient to ensure alignment
            val paddedIngredient = ingredient.padEnd(10) // Adjust the width as needed
            binding.ingText.text=
                """${binding.ingText.text} ● $paddedIngredient
